 ...
 * Install Python 2.7 or Python 3 <= 3.13.0.
   The minimum python version supported by driver is python 2.7 and the latest version supported is python 3.13.0 except version 3.3 as it has reached end-of-life.
 * Django Framework 2.2.0 or 3.1 or 3.2 or 4.2 or 5.2
...
For Django 5.2,
	$ pip install ibm_db_django>=1.6.0.0
```
